...
describe('RichTextViewer', () => {
  ...
  it('dispatches inline comments, dice, mentions, reply gates, attachments, polls, links, and spoilers', async () => {
    ...
    const histogramFills = document.querySelectorAll('.rt-poll__histogram-fill')
    expect(histogramFills[0]).toHaveStyle({ width: '36%' })
    expect(histogramFills[1]).toHaveStyle({ width: '64%' })

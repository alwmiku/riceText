...
export function ImageDialog({
  ...
  const valid =
    asset !== null ||
    /^(https?:\/\/|\/api\/assets\/|\/uploads\/|blob:)/i.test(src);
  ...
  return (
    <Dialog
      ...
      title={editing ? "编辑图片" : "插入图片"}
      description="可使用 HTTP(S) 外链，或上传到本站媒体服务。"
      className="max-w-xl"
      footer={
        <>
          ...
          <Button
            ...
            onClick={() => {
              onInsert(asset, { src, alt, caption, align, width });
              onOpenChange(false);
            }}
          >
            {editing ? "保存修改" : "插入图片"}
    ...
    >
      <div className="grid gap-4">
        ...
        />
        {src && (
          <div className="grid h-36 place-items-center overflow-hidden rounded-md bg-muted">
            <img
              src={src}
              alt="图片预览"

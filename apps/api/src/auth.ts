...
import type { DemoUser } from "@ricetext/contracts";
import type { DatabaseSync } from "node:sqlite";

/** 每个请求解析出的身份；生产可替换为 JWT/SSO。 */
export type RequestIdentity = DemoUser;
...
/** 使用 x-demo-user 头选择 SQLite 种子身份的开发适配器。 */
export class HeaderDemoAuthProvider implements AuthProvider {
